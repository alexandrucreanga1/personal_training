...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Album album = new Album("Stormbringer", "Deep Purple");
        album.addSong("StormBringer", 4.6);
        album.addSong("StormBraker", 4.22);
        album.addSong("Holy man", 4.3);
        album.addSong("Hold on", 5.6);
        album.addSong("Lady double dealer", 3.21);
        album.addSong("You can't do it right", 6.23);
        album.addSong("High ball shooter", 4.27);
        album.addSong("The gypsy", 4.2);
        album.addSong("Soldier of fortune", 3.12);
        // album.addAlbum(album);
        albums.add(album);


        album = new Album("For Those about to rock", "AC/DC");
        album.addSong("StormBfsdr", 4.6);
        album.addSong("Stosdfdraker", 4.22);
        album.addSong("Hrey man", 4.3);
        album.addSong("Hgffdgd on", 5.6);
        album.addSong("Lagfhgy double dealer", 3.21);
        album.addSong("Yogfhdfg do it right", 6.23);
        album.addSong("Hidfsdfsdl shooter", 4.27);
        album.addSong("Thedfdsdsy", 4.2);
        //  album.addAlbum(album);
        albums.add(album);

        LinkedList<Song> playList = new LinkedList<Song>();
        albums.get(0).addToPlayList("High ball shooter", playList);
        albums.get(0).addToPlayList("Stosdfdraker", playList);
